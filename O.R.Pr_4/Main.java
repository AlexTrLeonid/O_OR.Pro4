//Сначала создадим класс Учитель, который будет представлять учителей:
...
//Теперь создадим класс УчительСервис, который будет отвечать за управление учителями:
...
//Теперь создадим класс УчительВью, который будет отвечать за отображение информации о учителях:
...
//Создадим класс УчительКонтроллер, который будет объединять все действия с учителями:
